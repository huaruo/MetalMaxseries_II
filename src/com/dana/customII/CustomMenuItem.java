...
public class CustomMenuItem
{
	...
	/**
	 * Use this method to set the resourceID for the drawable displayed for a menu item.
	...
	/**
	 * Use this method to get the resourceID for the drawable displayed for a menu item.
